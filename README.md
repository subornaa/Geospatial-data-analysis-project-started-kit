...
4. All required packages to run the jupyter notebook on this repository should now be installed. You can see more information about package requirements in the `pyproject.toml` file.
